...
run: compile
	./compile
compile: main.o render_frame.o vector3D.o matrix3D.o
	gcc main.o render_frame.o vector3D.o matrix3D.o -o compile
main.o: main.c render_frame.h vector3D.h matrix3D.h
